	...
	return (
		<>
			<div className='mainContainer'>
				{!showResults && (
					<Typography variant='h2' component='h2' className='webmainlabel'>
			...
			<div className='mainContainer'>
				{!mobshowResults && (
					<Typography variant='h4' component='h2' className='mobmainlabel'>
						Please Rate these movies
					</Typography>
				)}
				{mobshowResults && (
				...
				{mobshowResults && (
					<div className='mobresultscontainer'>
				...
				{!mobshowResults && (
					<div className='mobslidercontainer'>
						<MobMainImgSlider
							setResults={setmobResultsarr}
							setShowResults={setmobResults}
						/>
					</div>
				)}
			</div>
